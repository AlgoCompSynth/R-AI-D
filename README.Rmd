...
- the [Quarto](https://quarto.org/ "Quarto home page") scientific and technical publishing
  system,
- the [Faust](https://github.com/grame-cncm/faust/blob/master-dev/documentation/faust-quick-reference.pdf "Faust Quick Reference (PDF)")
...
- the [Ollama](https://docs.ollama.com/ "Ollama Documentation") framework for managing local
  models, and
